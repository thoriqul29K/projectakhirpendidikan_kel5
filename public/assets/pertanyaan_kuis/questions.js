const myQuestions = [
  {
    ...
    background: "<img src='https://drive.google.com/uc?export=download&id=1FFu8M1So522mwECeDsawVidGWOmcAeQ2'>",
    answers: {
  ...
  },
  {
    ...
    background: "<img src='assets/images/bg_slide2.jpg'>",
    answers: {
  ...
  },
  {
    ...
    background: "<img src='assets/images/bg_slide3.jpg'>",
    answers: {
  ...
  },
  {
    ...
    background: "<img src='assets/images/bg_slide4.gif'>",
    answers: {
      a: "X1",
      b: "X2",
      c: "X3"
  ...
  },
  {
    ...
    background: "<img src='assets/images/bg_slide5.jpg'>",
    answers: {
  ...
  },
  {
    ...
    background: "<img src='<?= base_url('assets/images/bg_slide5.jpg') ?>'>",
    answers: {
      a: "Orang hebat",
      b: "Orang tidak hebat",
