...
<section id="Feedback">
    <div class="kolom">
        ...
        <p><a href="https://api.whatsapp.com/send?phone=6285960362304" class="tbl-biru">Klik Disini</a></p>
        ...
        <section id="Developer">
            <div class="tengah">
                <div class="kolom">
                    ...
                    <h2>PEMBELAJARAN</h2>
                    <p>Dibawah ini adalah beberapa modul pembelajaran yang sering dipakai, untuk lebih lengkap, silahkan pilih <a href="<?= base_url('/') ?>">materi</a> pada navbar</p>
                </div>

                <div class="Developer-list"> 
                    <div class="kartu-Developer"> 
                    ...
                    <div class="kartu-Developer">
                        ...
                        <p><a href="#">Praktikum Keamanan Komputer</a></p>
                        <p style="font-size: 16px;">Praktikum keamanan komputer adalah suatu kegiatan pembelajaran yang bertujuan untuk memberikan pemahaman dan keterampilan dalam melindungi sistem komputer, jaringan, dan data dari ancaman dan serangan yang berpotensi merugikan. Dalam praktikum ini, peserta biasanya akan mempelajari berbagai aspek keamanan siber melalui simulasi, eksperimen, dan penggunaan alat-alat keamanan.</p>
                    </div>
                    <div class="kartu-Developer">
                        <img src="<?= base_url('assets/images/PRW.jpg') ?>" alt="Praktikum Rekayasa Web">
                        <p><a href="#">Praktikum Rekayasa Web</a></p>
                        <p style="font-size: 16px;">Praktikum rekayasa web adalah kegiatan pembelajaran yang bertujuan untuk memberikan pemahaman dan keterampilan dalam merancang, membangun, dan mengelola aplikasi dan situs web. Dalam praktikum ini, peserta belajar tentang berbagai aspek pengembangan web, mulai dari perencanaan hingga penerapan teknologi web yang modern.</p>
                    </div>
                    <div class="kartu-Developer">
                        <img src="<?= base_url('assets/images/PPV.png') ?>" alt="Praktikum Pemrograman Visual">
                        <p><a href="#">Praktikum Pemrograman Visual</a></p>
                        <p style="font-size: 16px;">Praktikum pemrograman visual adalah kegiatan pembelajaran yang fokus pada penggunaan lingkungan pemrograman yang menyediakan antarmuka grafis untuk pengembangan perangkat lunak. Dalam praktikum ini, peserta belajar untuk membuat aplikasi dengan cara yang lebih intuitif dan interaktif, biasanya tanpa harus menulis banyak kode secara manual.</p>
                    </div>
                    <div class="kartu-Developer">
                        <img src="<?= base_url('assets/images/PAD.png') ?>" alt="Praktikum Analisis Data">
                        <p><a href="#">Praktikum Analisis Data</a></p>
                        <p style="font-size: 16px;">Praktikum analisis data adalah kegiatan pembelajaran yang bertujuan untuk memberikan pemahaman dan keterampilan dalam mengumpulkan, mengolah, dan menganalisis data untuk menghasilkan informasi yang berguna. Dalam praktikum ini, peserta belajar menggunakan berbagai teknik dan alat analisis untuk menjawab pertanyaan penelitian atau mendukung pengambilan keputusan.</p>
                    </div>
                </div>
            </div> 
        </section>
