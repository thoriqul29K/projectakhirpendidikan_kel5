...
<div class="wrapper">
    <!-- untuk home -->
    <section id="home" style="background-image: url('/assets/images/background home.jpg'); background-size: cover; background-position: center; ">
        <div class="kolom_p">
            <br> <br>
        ...
        <div class="tengah">
            ...
            <div class="Materi-list">
                ...
                <div class="kartu-Materi">
                    ...
                    <p><a href="assets/materi/modul_RW.pdf">Rekayasa Web</a></p>
                ...
                <div class="kartu-Materi">
                    ...
                    <p><a href="<?= base_url('assets/materi/modul_PV.pdf') ?>">Pemrograman Visual</a></p>
                ...
                <div class="kartu-Materi">
                    ...
                    <p><a href="<?= base_url('assets/materi/modul_AD.pdf') ?>">Analisis Data</a></p>
